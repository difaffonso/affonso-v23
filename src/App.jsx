...
<span style={{fontSize:10,fontWeight:700,color:isPartial?G.red:SC[a.status],background:(isPartial?G.red:SC[a.status])+"25",borderRadius:5,padding:"2px 7px"}}>{<><Icon n={SC_ICON[a.status]} s={11}/> {SL[a.status]}</>}</span>
</div>
