...
const ANAM_CONDS=[["hypertension","Pressão alta"],["diabetes","Diabetes"],["heartDisease","Problema no coração"],["rheumaticFever","Febre reumática / válvula"],["bleeding","Problema de coagulação"],["anticoagulant","Usa anticoagulante"],["osteoporosis","Osteoporose"],["bisphosphonate","Usa/usou bifosfonato"],["kidneyDisease","Doença renal"],["liverDisease","Doença no fígado"],["hepatitis","Hepatite (B ou C)"],["hiv","HIV / AIDS"],["infectious","Doença infectocontagiosa"],["thyroid","Tireoide"],["epilepsy","Epilepsia / convulsões"],["cancer","Câncer / quimioterapia"],["pregnant","Gestante"],["smoking","Fumante"]];
